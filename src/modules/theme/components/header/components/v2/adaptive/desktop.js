...
const DesktopHeader = (props) => {
        ...
        return (
            <ul className={cx('my-account-list__wrapper')}>
                <li key={0} className={cx('my-account-list__item', 'py-2', 'px-2', 'text-left')}>
                    <Typography className={cx('currency-list__text', '!text-primary-700')}>Hi, {customer?.firstname}</Typography>
                </li>
    ...
    return (
        <div className={cx('desktop-header', 'transition-transform', 'delay-300', 'duration-500', 'ease-in-out', 'shadow-md')}>
            <div className={cx('middle-header', 'tablet:border-b-[0px]', 'tablet:border-b-neutral-200', 'mobile:p-3 tablet:py-5 desktop:py-0')}>
                <div
                    className={cx(
                        ...
                        'desktop:gap-x-5',
                        'px-4 mobile:max-tablet:px-0',
                        'tablet:px-6',
                        'desktop:gap-x-6',
                        'desktop:max-w-screen-desktop',
                        'desktop:px-10',
                        'mobile:max-tablet:grid',
                        'mobile:max-tablet:grid-cols-[8fr_1fr]',
                ...
                >
                                    ...
                                    <div className="xs:basis-full menu-middle w-max">
                                        <nav className={cx('menu-wrapper')} role="navigation">
                                            {loadingMenu ? (
                                                ...
                                                <Menu useOthers t={t} data={dataMenu} cmsMenu={cmsMenu} storeConfig={storeConfig} />
                                            )}
                                        </nav>
                                    </div>
                                </div>
                    ...
                    <div className={cx('middle-header__statusicon', 'flex flex-row items-center')}>
                        <div
                            className={cx(
                                ...
                                'flex-row',
                                'gap-x-3',
                                'justify-center items-center item',
                            )}
                        >
                            <div className="search-icon justify-center items-center flex">
                                <Button
                                    className={cx(
                                        'mt-0',
                                        '!px-0',
